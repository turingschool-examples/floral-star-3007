...
RSpec.describe AmusementPark do
  ...
  before :each do
    ...
    @ride1 = Ride.create!(name: 'Alpine Swing', thrill_rating: '10', open: true, amusement_park_id: @park1.id)
  ...
  it 'gets avg_thrill_rating' do
    expect(@park1.avg_thrill_rating).to eq(20)
  end
end
